...
// 用户信息接口（可以用来验证登录态）
router.get('/user', validationMiddleware, controllers.user.validation)
router.get('/user/all', controllers.user.pagedGetAll)
router.get('/user/id', controllers.user.getOneById)
router.post('/user/update', controllers.user.updateUser)
